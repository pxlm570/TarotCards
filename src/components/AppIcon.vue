...
const ICONS = {
  ...
  // 火焰：连胜胶囊（实底造型，随胶囊配色）
  flame:
    '<path fill="currentColor" stroke="none" d="M12 2c.6 2.9-.2 4.7-1.5 6.2C9.2 9.7 8 11.2 8 13.4a4 4 0 0 0 8 0c0-1.4-.5-2.6-1.3-3.6-.4 1-1 1.7-1.9 2.1.7-2.7.2-6.4-.8-9.9z"/>',
  sparkle:
